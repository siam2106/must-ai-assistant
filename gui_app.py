...
def load_rag_chain():
    ...
    # 🔁 Auto-Build Logic: Checks if collection exists on the cloud server
    try:
        ...
        # If it fails (like on Streamlit Cloud), read the text file and build it instantly
        with st.spinner("Initializing first-time vector database build from text file..."):
