...
st.caption("Connected to Cloud In-Memory Qdrant DB")
...
def load_rag_chain():
    ...
    # 🔥 THE UNLOCKER: Use pure in-memory client to completely kill folder locks
    ...
    with st.spinner("Loading and vectorizing university data into cloud memory..."):
        ...
        # Build vector store completely in RAM
